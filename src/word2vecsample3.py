...
def main():
    ...
    try:
        strs =[]
        print('Please input modelfile')
        mf = input('>>')
        print('Please input word multiple word input word after space')
        files = input('>>')
        strs = files.split()
        ...
        if num == 1: 
           words = get_similor_word(model,strs[0])
           print('-------------------------------------')
           ...
           print('-------------------------------------')
           for i in range(num):
               rcos =comp_words(model,strs[0],strs[1])
               print("{0}\t|{1}\t|{2}".format(strs[0],strs[1],rcos))
           print('-------------------------------------')
